...
/**
 * Brand marks are rendered in currentColor, not brand colours. Google's logo
 * is blue, red, yellow and green — dropping it in as-is would put red and
 * green on screen for something that has nothing to do with price movement.
 */
